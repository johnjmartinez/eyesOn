...
namespace Emgu.CV.LineDescriptor
{
...
#endif
   {
      ...
      {
         return new InputArray( cvInputArrayFromVectorOfKeyLine(_ptr) );
      }
      ...
      {
         return new OutputArray( cvOutputArrayFromVectorOfKeyLine(_ptr) );
      }
      ...
      {
         return new InputOutputArray( cvInputOutputArrayFromVectorOfKeyLine(_ptr) );
      }
